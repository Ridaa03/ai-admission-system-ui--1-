...
import { Menu, X, LogOut, Home, FileText, CheckCircle, Zap, Award, Settings } from "lucide-react"
...
export default function StudentLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { icon: FileText, label: "Upload Documents", href: "/student/documents" },
    { icon: CheckCircle, label: "Eligibility Check", href: "/student/eligibility" },
    { icon: Zap, label: "Program Selection", href: "/student/programs" },
    { icon: Award, label: "Merit List", href: "/student/merit-list" },
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="p-6 border-b border-border">
          <h1 className="text-xl font-bold text-foreground">Admission Portal</h1>
        </div>
